...
declare const _default: {
     ...
     * @type {Object|null}
     */
    DEFAULT_TEXT_TRACK_MODE: "html" | "native";
    /**
     ...
     * @type {Number}
     */
    DISCONTINUITY_THRESHOLD: number;
    /**
     ...
     * @type {Number}
     */
    INITIAL_BACKOFF_DELAY_BASE: number;
    /**
     ...
     * @type {Number}
     */
    ABR_STARVATION_FACTOR: number;
    /**
     * Factor with which is multiplied the bandwidth estimate when the ABR is not
     * in starvation mode.
     * @type {Number}
     */
    ABR_REGULAR_FACTOR: number;
    /**
     ...
     * @type {Number}
     */
    ABR_STARVATION_GAP: number;
    OUT_OF_STARVATION_GAP: number;
    /**
