...
if (navigator.requestMediaKeySystemAccess) {
    requestMediaKeySystemAccess =
        function (a, b) { return castToObservable(navigator.requestMediaKeySystemAccess(a, b)); };
}
else {
        ...
        requestMediaKeySystemAccess = function (keyType, keySystemConfigurations) {
            ...
            for (var i = 0; i < keySystemConfigurations.length; i++) {
                ...
                supported = supported &&
                    (!initDataTypes ||
                        !!initDataTypes
                            .filter(function (initDataType) { return initDataType === "cenc"; })[0]);
                supported = supported &&
                    (!sessionTypes ||
                        sessionTypes
                            .filter(function (sessionType) {
