...
import { MediaKeys_, } from "../constants";
        ...
        requestMediaKeySystemAccess = function (keyType, keySystemConfigurations) {
            ...
            for (var i = 0; i < keySystemConfigurations.length; i++) {
                ...
                if (supported) {
                    ...
                    return observableOf(new CustomMediaKeySystemAccess(keyType, new MockMediaKeys(keyType), keySystemConfigurationResponse));
                }
            }
            return observableThrow(undefined);
        };
