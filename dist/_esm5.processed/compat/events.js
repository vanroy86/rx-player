...
import { debounceTime, distinctUntilChanged, filter, map, mapTo, startWith, } from "rxjs/operators";
import config from "../config";
import log from "../log";
import { HTMLElement_, } from "./constants";
...
function videoWidth$(mediaElement) {
    return observableMerge(observableInterval(20000).pipe(mapTo(null)), videoSizeChange().pipe(debounceTime(500)))
        .pipe(startWith(null), // emit on subscription
