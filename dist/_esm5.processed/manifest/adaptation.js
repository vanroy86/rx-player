...
var Adaptation = /** @class */ (function () {
    ...
    function Adaptation(args, representationFilter) {
        ...
        if (hadRepresentations && argsRepresentations.length === 0) {
            ...
            var error = new MediaError("MANIFEST_INCOMPATIBLE_CODECS_ERROR", "An Adaptation contains only incompatible codecs.", false);
    ...
    Adaptation.prototype.getAvailableBitrates = function () {
        var bitrates = this.representations.map(function (r) { return r.bitrate; });
