...
import { convertToRanges, getInnerAndOuterTimeRanges, getLeftSizeOfRange, getNextRangeGap, getPlayedSizeOfRange, getRange, getSizeOfRange, isTimeInRange, keepRangeIntersection, } from "../ranges";
/**
 ...
 * @returns {Object}
 */
function constructTimeRanges(base) {
    var starts = [];
    var ends = [];
    var timeRanges = {
        length: 0,
...
describe("utils - ranges", function () {
    describe("convertToRanges", function () {
        it("should convert TimeRanges to custom Ranges implementation", function () {
            var times = [
                [0, 10],
                [20, 30],
                [50, 70],
            ];
            var timeRanges = constructTimeRanges(times);
            var ranges = convertToRanges(timeRanges);
        ...
        it("should return empty array if no timerange is given", function () {
            var times = [];
            var timeRanges = constructTimeRanges(times);
            var ranges = convertToRanges(timeRanges);
            expect(ranges).to.deep.equal([]);
    ...
    describe("getInnerAndOuterTimeRanges", function () {
        /* tslint:disable max-line-length */
        it("should get inner range and outer ranges with the given TimeRanges and number", function () {
            /* tslint:enable max-line-length */
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
            ]);
        ...
        it("should return a null innerRange if the number given isn't in any range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
        ...
        /* tslint:disable max-line-length */
        it("should return an empty outerRanges if the number given is in the single range given", function () {
            /* tslint:enable max-line-length */
            var timeRanges = constructTimeRanges([
                [20, 30],
            ]);
        ...
        it("should return null ane empty array if no timerange is given", function () {
            var times = [];
            var timeRanges = constructTimeRanges(times);
            expect(getInnerAndOuterTimeRanges(timeRanges, 0)).to.deep
                .equal({
    ...
    describe("getLeftSizeOfRange", function () {
        it("should return the left time to play in the current time range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
        ...
        it("should return Infinity if the given time is at the edge of a range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
        ...
        it("should return Infinity if the given time is not in any range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
    ...
    describe("getNextRangeGap", function () {
        /* tslint:disable max-line-length */
        it("should return gap until next range if the given number is not in any range", function () {
            /* tslint:enable max-line-length */
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
        ...
        /* tslint:disable max-line-length */
        it("should return gap until next range if the given number is in a range", function () {
            /* tslint:enable max-line-length */
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
        ...
        it("should return Infinity when we are in the last time range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
        ...
        it("should return Infinity when we are after the last time range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
    ...
    describe("getPlayedSizeOfRange", function () {
        it("should return the time before the current time in the current range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
        ...
        it("should return 0 if the given time is at the edge of a range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
        ...
        it("should return 0 if the given time is not in any range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
    ...
    describe("getRange", function () {
        it("should return the current range from the TimeRanges given", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
        ...
        it("should return null if the given time is at the edge of a range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
        ...
        it("should return null if the given time is not in any range", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
    ...
    describe("getSizeOfRange", function () {
        it("should return the size of the current range from the TimeRanges given", function () {
            var timeRanges = constructTimeRanges([
                [0, 10],
                [20, 30],
                [50, 70],
    ...
    describe("keepRangeIntersection", function () {
        it("should return the same range if both given are equal", function () {
            var timeRanges = [
                { start: 0, end: 10 },
                { start: 20, end: 30 },
                { start: 50, end: 70 },
        ...
        it("should return the other range if one of it contains the other", function () {
            var timeRanges1 = [
                { start: 0, end: 10 },
                { start: 20, end: 30 },
                { start: 50, end: 70 },
        ...
        it("should return the intersection between two ranges", function () {
            var timeRanges1 = [
                { start: 0, end: 10 },
                { start: 20, end: 30 },
                { start: 50, end: 70 },
    ...
    describe("isTimeInRange", function () {
        it("should return true if the given time is equal to the start of the range", function () {
        ...
        it("should return false if the given time is equal to the end of the range", function () {
        ...
        it("should return true if the given time is inside the range", function () {
        ...
        it("should return false if the given time is not inside the range", function () {
