...
var initialArrayIncludes = Array.prototype.includes;
/* tslint:enable no-unbound-method */
describe("utils - array-includes", function () {
    before(function () {
    ...
    it("should be true if a number is included", function () {
    ...
    it("should be false if a number is not included", function () {
    ...
    it("should be true for NaN values", function () {
        expect(arrayIncludes([1, NaN, 3, 4, 5], NaN)).to.equal(true);
    });
    it("should be true if a string is included", function () {
    ...
    it("should be true if a boolean is included", function () {
    ...
    it("should be true if an object is included", function () {
        var obj1 = { a: 4, b: 3 };
        var obj2 = { a: obj1, b: { a: 4 } };
    ...
    it("should be false if an object is not included", function () {
        var obj1 = { a: 4, b: 3 };
        var obj2 = { a: obj1, b: { a: 4 } };
        var obj3 = { o: 4 };
        var obj4 = { z: obj1, t: { a: 4 } };
        expect(arrayIncludes([obj1, obj2, obj3], obj4))
            .to.equal(false);
        expect(arrayIncludes([1, obj4, 3, obj3, 5], obj2)).to.equal(false);
    });
    it("should not work for deep equality with objects", function () {
        var obj1 = { a: 4, b: 3 };
        var obj2 = { a: obj1, b: { a: 4 } };
        var obj2bis = { a: obj1, b: { a: 4 } };
