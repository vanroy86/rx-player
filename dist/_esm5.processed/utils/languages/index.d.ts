 ...
 * @returns {string}
 */
declare function normalize(_language: string): string;
/**
...
export { normalize, normalizeAudioTrack, normalizeTextTrack, INormalizedTextTrackObject, INormalizedAudioTrackObject, };
