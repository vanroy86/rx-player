...
interface IBackoffOptions {
    ...
    resetDelay?: number;
    errorSelector?: (error: Error | ICustomError, retryCount: number) => Error | ICustomError;
 ...
 */
declare function retryObsWithBackoff<T>(obs$: Observable<T>, options: IBackoffOptions): Observable<T>;
/**
 ...
 * @returns {Observable}
 */
declare function retryFuncWithBackoff<T>(func: () => T, options: IBackoffOptions): Observable<T>;
/**
 ...
 * an Observable.
 */
declare function retryableFuncWithBackoff<T, I>(fn: (...args: T[]) => Observable<I>, options: IBackoffOptions): (...args: T[]) => Observable<I>;
export { retryObsWithBackoff, retryableFuncWithBackoff, retryFuncWithBackoff, ICustomError, };
