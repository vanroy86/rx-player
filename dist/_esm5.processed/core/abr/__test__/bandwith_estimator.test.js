...
describe("ABR - BandwidthEstimator", function () {
    it("should return undefined if no sample has been added yet", function () {
        var bwEstimator = new BandwidthEstimator();
        expect(bwEstimator.getEstimate()).to.equal(undefined);
    });
    it("should return undefined if not enough bytes has been received", function () {
        var bwEstimator = new BandwidthEstimator();
    ...
    it("should calculate bitrate in function of consecutive request' durations and size", function () {
    ...
    it("should reset the estimation when reset is called", function () {
        var bwEstimator = new BandwidthEstimator();
        bwEstimator.addSample(8000, 1000000);
        bwEstimator.addSample(4000, 1000000);
        bwEstimator.addSample(1000, 1000000);
    ...
    it("should estimate a low bitrate quicker than a higher one", function () {
        var bwEstimator = new BandwidthEstimator();
        // 1st test:
