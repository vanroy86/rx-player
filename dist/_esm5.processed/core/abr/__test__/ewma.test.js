...
describe("ABR - EWMA", function () {
    it("should return the last bitrate if half-life is at 0", function () {
        var ewma = new EWMA(0);
    ...
    it("should returns the correct value bitrate for a given positive half-life", function () {
        // "slow" evolution
        var ewma1 = new EWMA(15);
