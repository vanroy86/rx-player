...
import { IABREstimation, IRepresentationChooserClockTick, IRequest } from "./representation_chooser";
...
export default class ABRManager {
     ...
     */
    constructor(requests$: Observable<Observable<IRequest>>, metrics$: Observable<IMetric>, options?: IRepresentationChoosersOptions);
    /**
     ...
     * @returns {Observable}
     */
    get$(type: IBufferType, clock$: Observable<IABRClockTick>, representations?: Representation[]): Observable<IABREstimation>;
    /**
...
export { IABREstimation, IRequest as IABRRequest, IMetric as IABRMetric, IRepresentationChoosersOptions as IABROptions, };
