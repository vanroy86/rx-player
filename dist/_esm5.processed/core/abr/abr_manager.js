...
var defaultChooserOptions = { limitWidth: {},
    throttle: {},
    initialBitrates: {},
    manualBitrates: {},
    maxAutoBitrates: {} };
 ...
 */
var createChooser = function (type, mediaElement, options) {
...
var ABRManager = /** @class */ (function () {
     ...
     */
    function ABRManager(mediaElement, requests$, metrics$, options) {
        var _this = this;
    ...
    ABRManager.prototype._lazilyCreateChooser = function (bufferType) {
        if (!this._choosers[bufferType]) {
            ...
            this._choosers[bufferType] = createChooser(bufferType, this._mediaElement, this._chooserInstanceOptions);
        }
