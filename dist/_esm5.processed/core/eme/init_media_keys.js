 ...
 * @returns {Observable}
 */
export default function initMediaKeys(mediaElement, keySystemsConfigs, currentMediaKeysInfos) {
    return getMediaKeysInfos(mediaElement, keySystemsConfigs, currentMediaKeysInfos)
        ...
        return observableConcat(observableOf({ type: "created-media-keys",
            value: mediaKeysInfos }), attachMediaKeys(mediaKeysInfos, mediaElement, currentMediaKeysInfos)
