 ...
 * @returns {Function}
 */
export default function createManifestPipeline(pipelines: ITransportPipelines, pipelineOptions: IPipelineManifestOptions, warning$: Subject<Error | ICustomError>): (args: IFetchManifestOptions) => Observable<IFetchManifestResult>;
export {};
