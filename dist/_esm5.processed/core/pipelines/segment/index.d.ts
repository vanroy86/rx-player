...
export default class SegmentPipelinesManager<T> {
     ...
     * @returns {Object}
     */
    createPipeline(bufferType: IBufferType, options: IPipelineLoaderOptions<ISegmentLoaderArguments, T>): IPrioritizedSegmentFetcher<T>;
}
export { IPipelineLoaderOptions as IPipelineOptions, IPrioritizedSegmentFetcher, IFetchedSegment, };
