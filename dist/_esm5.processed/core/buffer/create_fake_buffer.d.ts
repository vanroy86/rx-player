 ...
 * @returns {Observable}
 */
export default function createFakeAdaptationBuffer(bufferClock$: Observable<IAdaptationBufferClockTick>, wantedBufferAhead$: Observable<number>, bufferType: IBufferType, content: {
    manifest: Manifest;
    period: Period;
