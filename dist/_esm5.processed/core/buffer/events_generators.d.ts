...
import { IActivePeriodChangedEvent, IAdaptationChangeEvent, IBitrateEstimationChangeEvent, IBufferEventAddedSegment, IBufferNeedsDiscontinuitySeek, IBufferNeedsManifestRefresh, IBufferStateActive, IBufferStateFull, IBufferWarningEvent, ICompletedBufferEvent, IEndOfStreamEvent, INeedsStreamReloadEvent, IPeriodBufferClearedEvent, IPeriodBufferReadyEvent, IRepresentationChangeEvent, IResumeStreamEvent } from "./types";
declare const EVENTS: {
    ...
    warning(value: Error | import("../../errors/EncryptedMediaError").default | import("../../errors/MediaError").default | import("../../errors/OtherError").default | import("../../errors/NetworkError").default): IBufferWarningEvent;
};
