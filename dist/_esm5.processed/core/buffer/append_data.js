 ...
 * @returns {Observable}
 */
function appendDataToSourceBuffer(queuedSourceBuffer, _a) {
    var segment = _a.segment, initSegmentData = _a.initSegmentData, segmentData = _a.segmentData, segmentOffset = _a.segmentOffset;
    var append$;
    if (segment.isInit) {
