...
import { IRepresentationBufferClockTick } from "./representation_buffer";
...
export { createFakeBuffer, IBufferEventAddedSegment, IBufferNeedsDiscontinuitySeek, IBufferNeedsManifestRefresh, IBufferStateActive, IBufferStateFull, };
