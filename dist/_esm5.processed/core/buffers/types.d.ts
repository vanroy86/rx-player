...
export interface ICrashedBufferEvent {
    type: "buffer-error-event";
    value: MediaError;
}
...
export declare type IMultiplePeriodBuffersEvent = IPeriodBufferEvent | IPeriodBufferClearedEvent | ICompletedBufferEvent | ICrashedBufferEvent;
export declare type IBufferOrchestratorEvent = IActivePeriodChangedEvent | IMultiplePeriodBuffersEvent | IEndOfStreamEvent | IResumeStreamEvent | ICrashedBufferEvent;
