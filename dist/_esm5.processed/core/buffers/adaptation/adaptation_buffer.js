...
import { asapScheduler, BehaviorSubject, concat as observableConcat, defer as observableDefer, merge as observableMerge, of as observableOf, Subject, } from "rxjs";
import { distinctUntilChanged, filter, ignoreElements, map, observeOn, share, takeUntil, tap, } from "rxjs/operators";
import log from "../../../log";
...
export default function AdaptationBuffer(clock$, queuedSourceBuffer, segmentBookkeeper, segmentFetcher, wantedBufferAhead$, content, abrManager, options) {
    ...
    var lastStableBitrate$ = new BehaviorSubject(undefined);
    var representations = adaptation.representations;
    var eventsForABR$ = new Subject();
    var abr$ = abrManager.get$(adaptation.type, representations, abrClock$, eventsForABR$)
    ...
    var bitrateEstimates$ = abr$.pipe(tap(function (_a) {
        var lastStableBitrate = _a.lastStableBitrate;
