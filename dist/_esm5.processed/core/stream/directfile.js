 ...
 * @returns {Observable}
 */
export default function StreamDirectFile(_a) {
    ...
    var _b = seekAndLoadOnMediaEvents(mediaElement, initialTime, autoPlay), seek$ = _b.seek$, load$ = _b.load$;
    // Create EME Manager, an observable which will manage every EME-related
    // issue.
    var emeManager$ = createEMEManager(mediaElement, keySystems);
    // Translate errors coming from the media element into RxPlayer errors
    // through a throwing Observable.
    var errorManager$ = createMediaErrorManager(mediaElement);
    ...
    return observableMerge(loadedEvent$, initialSeek$, emeManager$, errorManager$, speedManager$, stallingManager$, linkURL$);
}
