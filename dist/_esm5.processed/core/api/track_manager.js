...
function normalizeAudioTracks(tracks) {
    return tracks.map(function (t) { return t && { normalized: normalizeLanguage(t.language),
...
var TrackManager = /** @class */ (function () {
    ...
    TrackManager.prototype.addPeriod = function (bufferType, period, adaptation$) {
        ...
        if (periodItem != null) {
            ...
            this._periods.add((_a = { period: period }, _a[bufferType] = { adaptations: period.adaptations[bufferType] ||
                    [],
                adaptation$: adaptation$, }, _a));
        }
    };
    /**
