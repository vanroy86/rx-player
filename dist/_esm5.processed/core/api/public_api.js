...
var Player = /** @class */ (function (_super) {
    ...
    function Player(options) {
        ...
        _this.version = /*PLAYER_VERSION*/ "3.13.0";
        _this.log = log;
        _this.state = "STOPPED";
    ...
    Player.prototype.loadVideo = function (opts) {
        ...
        if (!isDirectFile) {
            ...
            var pipelines = transportFn(objectAssign({ supplementaryTextTracks: supplementaryTextTracks,
            ...
            var adaptiveOptions = {
                ...
                throttle: this._priv_throttleWhenHidden ?
                    { video: isInBackground$()
                            .pipe(map(function (isBg) { return isBg ? 0 :
                            Infinity; }), takeUntil(this._priv_stopCurrentContent$)), } :
                    {},
            ...
            playback$ = initializeMediaSourcePlayback({
                ...
                autoPlay: autoPlay,
                bufferOptions: objectAssign({ manualBitrateSwitchingMode: manualBitrateSwitchingMode }, this._priv_bufferOptions),
                clock$: clock$,
            ...
            playback$ = features.directfile({ autoPlay: autoPlay,
                clock$: clock$,
                keySystems: keySystems,
                mediaElement: videoElement,
                speed$: this._priv_speed$,
                startAt: startAt,
                url: url }).pipe(takeUntil(contentIsStopped$))
                .pipe(publish());
        }
