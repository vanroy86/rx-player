...
import { onEnded$, onSeeked$, onSeeking$, } from "../../../../compat/events";
...
function generateClock(videoElement) {
    var seeking$ = onSeeking$(videoElement).pipe(mapTo(null));
    var seeked$ = onSeeked$(videoElement).pipe(mapTo(null));
    var ended$ = onEnded$(videoElement).pipe(mapTo(null));
...
export default HTMLTextTrackSourceBuffer;
