...
export default function initializeFeaturesObject() {
    ...
    /* tslint:disable no-var-requires */
    if (false) {
        features.transports.smooth = require("../net/smooth/index.js").default;
    }
    if (false) {
        features.transports.dash = require("../net/dash/index.js").default;
    }
    /* tslint:enable no-var-requires */
    /* tslint:disable no-var-requires */
    if (HAS_NATIVE_MODE) {
    ...
    /* tslint:disable no-var-requires */
    if (false) {
        features.directfile = require("../core/stream/directfile.js").default;
    }
    /* tslint:enable no-var-requires */
}
