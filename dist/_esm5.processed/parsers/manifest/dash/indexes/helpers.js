 ...
 */
function getTimelineItemRangeStart(_a) {
 ...
 */
function getTimelineItemRangeEnd(_a) {
    var start = _a.start, duration = _a.duration, repeatCount = _a.repeatCount;
...
function getSegmentsFromTimeline(index, from, durationWanted) {
    ...
    for (var i = 0; i < timelineLength; i++) {
        ...
        var repeat = calculateRepeat(timelineItem, timeline[i + 1]);
...
export { getInitSegment, getSegmentsFromTimeline, getTimelineItemRangeEnd, getTimelineItemRangeStart, getTimescaledRange, fromIndexTime, toIndexTime, };
