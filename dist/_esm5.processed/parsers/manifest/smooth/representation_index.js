...
var SmoothRepresentationIndex = /** @class */ (function () {
    function SmoothRepresentationIndex(index, options) {
        var aggressiveMode = options.aggressiveMode, segmentPrivateInfos = options.segmentPrivateInfos;
        ...
        if (index.timeline.length) {
            ...
            var scaledEnd = getTimelineRangeEnd(lastItem);
    ...
    SmoothRepresentationIndex.prototype.getSegments = function (_up, _to) {
        ...
        var maxPosition = this._isAggressiveMode || this._scaledLiveGap == null ?
    ...
    SmoothRepresentationIndex.prototype.getLastPosition = function () {
        ...
        for (var i = index.timeline.length - 1; i >= 0; i--) {
            ...
            var start = lastTimelineElement.start, duration = lastTimelineElement.duration, repeatCount = lastTimelineElement.repeatCount;
