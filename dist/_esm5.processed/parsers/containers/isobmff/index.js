...
import { be2toi, be3toi, be4toi, be8toi, concat, hexToBytes, itobe4, strToBytes, } from "../../../utils/bytes";
import { getPlayReadyKIDFromPrivateData } from "./drm";
import { getMDAT, getMDIA, getTRAF, } from "./read";
/**
...
function createPssh(_a) {
    ...
    return Atom("pssh", concat(4, // 4 initial zeroed bytes
...
export { getMDHDTimescale, getPlayReadyKIDFromPrivateData, getTrackFragmentDecodeTime, getDurationFromTrun, getSegmentsFromSidx, getMDAT, getMDIA, getTRAF, patchPssh, };
