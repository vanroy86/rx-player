...
describe("parsers - srt - parseCueBlocks", function () {
    it("should correctly parse regular cue blocks", function () {
    ...
    it("should add timeOffset in seconds", function () {
    ...
    it("should return null for invalid cue blocks", function () {
